CREATE TABLE [FJ].[pedidos_Juquilita] (
    ...
    CONSTRAINT [PK_pedidos_juquilita] PRIMARY KEY CLUSTERED ([cliente] ASC, [cod_barras] ASC, [cant_ped] ASC, [arch_cliente] ASC, [orden] ASC, [hash_md5] ASC, [fecha_pedido] ASC)
);
