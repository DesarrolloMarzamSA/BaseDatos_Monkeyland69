...
-- Description:	<Description,extrae la facturacion de farmacia juquilita ,>
-- =============================================
create  PROCEDURE [FJ].[usp_facturacion_FarmaciaJuquilita]
...
where		convert(varchar(10),t1.fecha_factura,112) >=  convert(varchar(10),GETDATE()-1,112) and  rtrim(t1.cliente)='06782'
END
