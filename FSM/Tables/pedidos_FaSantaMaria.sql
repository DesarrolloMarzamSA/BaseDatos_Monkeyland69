CREATE TABLE [FSM].[pedidos_FaSantaMaria] (
    ...
    CONSTRAINT [PK_pedidos_FaSantaMaria] PRIMARY KEY CLUSTERED ([cliente] ASC, [cod_barras] ASC, [cant_ped] ASC, [arch_cliente] ASC, [orden] ASC, [hash_md5] ASC, [fecha_pedido] ASC)
);
