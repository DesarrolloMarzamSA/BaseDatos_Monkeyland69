...
-- Description:	<Description,extrae la facturacion de farmacia santa maria ,>
-- =============================================
create PROCEDURE [FSM].[usp_facturacion_SantaMaria]
AS
BEGIN
...
where		convert(varchar(10),t1.fecha_factura,112) >=  convert(varchar(10),GETDATE()-1,112) and  rtrim(t1.cliente)in('12636','12558','12638','12640')
END
