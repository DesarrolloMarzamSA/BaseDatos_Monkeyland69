...
-- =============================================
create PROCEDURE [fbena].[VerificarArchivo] 
@nombre varchar(50)
AS
BEGIN
	...
	SET NOCOUNT ON;
    begin try
		select a.nombre,a.rutalocal,a.rutaserver,a.enviado,a.compania from fbena.PedidosTransmitidos a where a.nombre =@nombre
