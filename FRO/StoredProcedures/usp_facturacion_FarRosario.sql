...
-- =============================================
create PROCEDURE [FRO].[usp_facturacion_FarRosario]
...
where		convert(varchar(10),t1.fecha_factura,112) >=  convert(varchar(10),GETDATE()-1,112) and  rtrim(t1.cliente)='09614'
END
