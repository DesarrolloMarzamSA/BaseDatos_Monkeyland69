...
-- exec [sap].[usp_farmacon_archivos_xml_02]
-- =============================================
CREATE PROCEDURE [sap].[usp_farmacon_archivos_xml_02] 
	@fecha datetime
AS
--select * from openquery(as400,'select trim(natreg) as natreg from ma4620ef04.sronam where nanca1=''99599'' group by natreg')
-- exec [dbo].[usp_farmacon_archivos_xml_02] '2020-10-22'
--sap exec [MiddleWare].[IEmbarque].[ExtraccionEmbarquePlantilla] '','0011000006'
