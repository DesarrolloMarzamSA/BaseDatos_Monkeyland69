-- =============================================
-- Author:		<Author,,FRMH>
-- Create date: <Create Date,06/10/2021>
-- Description:	<Datos SAP Txt CFDI 3.3, FacturaPerfecta Farmacias Ahorro>
-- EXEC [sap].[usp_obtener_fahorro_DetalleFacturaCFDI] 0
-- =============================================
CREATE PROCEDURE [sap].[usp_obtener_fahorro_DetalleFacturaCFDI]
@periodo int=0
AS
BEGIN
    ...
    --  ,f.IDLINE,
	  ...
	  ,isnull(f.CodigoSat,'00000000')as CODIGOSAT
  ...
  FROM monkeyland.sap.detalle_fahorroFacturas f
