...
-- EXEC [sap].[usp_farmacon_archivos_xml_02_cfdi_reproceso]  '20210621'
-- =============================================
CREATE PROCEDURE [sap].[usp_farmacon_archivos_xml_02_cfdi_reproceso] 
 @fecha datetime
AS
BEGIN
	...
	SELECT 
		[serie],[Column1],[Column2],[Column3],[sucursal],[ctepadre],[filler]
