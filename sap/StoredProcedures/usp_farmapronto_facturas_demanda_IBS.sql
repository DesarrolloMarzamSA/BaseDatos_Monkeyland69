...
CREATE PROCEDURE [sap].[usp_farmapronto_facturas_demanda_IBS] 
...
begin
     ...
     SELECT [Remision]
       ...
       where [FechaEmision]>='2024-01-01' and [Sucursal]<>926 and [Folio] in (
'24117022',
'24117473',
'24117427',
'24116987',
...
--		 where folio in (select distinct VBELN from @extraccionEmbarque)
	...
	select * from @Salida_temporal WHERE sucursal NOT IN ('9')
