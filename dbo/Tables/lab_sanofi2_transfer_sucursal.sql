CREATE TABLE [dbo].[lab_sanofi2_transfer_sucursal] (
    ...
    PRIMARY KEY CLUSTERED ([ClaveSucursalOrig] ASC, [FechaImg] ASC, [HoraImg] ASC, [ClaveSucursalDest] ASC, [CodigoMat] ASC, [TipoMovimiento] ASC)
);
