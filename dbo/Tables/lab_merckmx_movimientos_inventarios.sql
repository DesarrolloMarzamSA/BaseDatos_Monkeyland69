CREATE TABLE [dbo].[lab_merckmx_movimientos_inventarios] (
    ...
    PRIMARY KEY CLUSTERED ([ClaveDist] ASC, [ClaveSucDist] ASC, [FechaMovimiento] ASC, [HoraMovimiento] ASC, [CodigoMat] ASC, [CodigoEAN] ASC, [ClaseMovimiento] ASC, [MotivoMovimiento] ASC, [OrigenMovimiento] ASC, [Cantidad] ASC) WITH (FILLFACTOR = 90)
);
