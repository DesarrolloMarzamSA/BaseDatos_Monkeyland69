CREATE TABLE [dbo].[pedidos_fbenavides_ci] (
    [linea]            INT           NOT NULL,
    ...
    PRIMARY KEY CLUSTERED ([linea] ASC, [fecha_pedido] ASC, [sucursal] ASC, [cliente] ASC, [pedido] ASC, [codigo] ASC, [cantidad_pedida] ASC, [hash_md5] ASC)
);


GO

CREATE NONCLUSTERED INDEX [idx_pedidos_fbenavides_ci_I]
    ON [dbo].[pedidos_fbenavides_ci]([sucursal] ASC, [cliente] ASC, [pedido] ASC, [arch_cliente] ASC, [archivo_hh] ASC);
