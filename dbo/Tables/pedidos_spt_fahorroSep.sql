CREATE TABLE [dbo].[pedidos_spt_fahorroSep] (
    ...
    [arch_tandem]          VARCHAR (30) NULL,
    [status]               VARCHAR (1)  NULL,
    [timestamp]            DATETIME     NULL,
    [remisionado]          INT          NULL,
    [descReciprocidad]     MONEY        NULL,
    [descAdicional1]       MONEY        NULL,
    [descAdicional2]       MONEY        NULL,
    [descAdicional3]       MONEY        NULL,
    [procesado_traductor]  INT          NOT NULL,
    [fecha_traductor]      VARCHAR (50) NULL,
