CREATE TABLE [dbo].[pedidoRamaSanPablo_historia] (
    ...
    [archivoPedido]      VARCHAR (150) NULL,
    [cantidadConfirmada] DECIMAL (18)  NULL,
    [archivoRespuesta]   VARCHAR (150) NULL,
    [fechaRespuesta]     DATETIME      NULL,
    CONSTRAINT [PK_pedidoRamaSanPablo_historia] PRIMARY KEY CLUSTERED ([lineaPedido] ASC, [numeroOrden] ASC, [numeroCita] ASC, [item] ASC, [codigoBarras] ASC, [hashMd5] ASC)
);
