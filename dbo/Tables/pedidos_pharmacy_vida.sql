CREATE TABLE [dbo].[pedidos_pharmacy_vida] (
    ...
    CONSTRAINT [PK_pedidos_pharmacy_vida] PRIMARY KEY CLUSTERED ([cliente] ASC, [cod_barras] ASC, [cant_ped] ASC, [arch_cliente] ASC, [orden] ASC, [hash_md5] ASC, [fecha_pedido] ASC)
);
