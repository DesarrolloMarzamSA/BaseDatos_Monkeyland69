CREATE TABLE [dbo].[tmp_az_factura_xml] (
    ...
    PRIMARY KEY CLUSTERED ([ClaveSucDist] ASC, [ClaveCliente] ASC, [Numero] ASC, [CodigoMat] ASC, [CantFacturada] ASC) WITH (FILLFACTOR = 90)
);
