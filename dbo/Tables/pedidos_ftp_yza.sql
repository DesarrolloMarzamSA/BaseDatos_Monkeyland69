CREATE TABLE [dbo].[pedidos_ftp_yza] (
...
CREATE NONCLUSTERED INDEX [idx_pedidos_ftp_yza]
    ON [dbo].[pedidos_ftp_yza]([sucursal] ASC, [cuenta] ASC, [num_pedido] ASC, [hash_md5] ASC, [codigo] ASC) WITH (FILLFACTOR = 90);
