CREATE TABLE [dbo].[mov_detalle_fahorroFacturas] (
    ...
    CONSTRAINT [PK_mov_detalle_fahorroFacturas] PRIMARY KEY CLUSTERED ([ID] ASC, [SUCURSAL] ASC, [IDINVN] ASC, [IDLINE] ASC, [IDPRDC] ASC, [IDQTY] ASC, [PRECIO_CANTIDAD] ASC) WITH (FILLFACTOR = 90)
);
