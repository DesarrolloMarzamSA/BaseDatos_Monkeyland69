CREATE TABLE [dbo].[pedidos_leyva_historia] (
    ...
    [precio_farmacia]                       VARCHAR (10) NULL,
    [importe_descuento_oferta_unitario]     VARCHAR (10) NULL,
    [importe_descuento_financiero_unitario] VARCHAR (10) NULL,
    [tasa_iva]                              VARCHAR (10) NULL,
    [fechahistoria]                         DATETIME     NOT NULL,
    CONSTRAINT [PK_pedidos_leyva_historia] PRIMARY KEY CLUSTERED ([cliente] ASC, [cod_barras] ASC, [cant_ped] ASC, [arch_cliente] ASC, [orden] ASC, [hash_md5] ASC, [fecha_pedido] ASC, [fechahistoria] ASC) WITH (FILLFACTOR = 90)
);
