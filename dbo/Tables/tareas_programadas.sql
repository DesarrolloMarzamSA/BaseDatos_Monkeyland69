CREATE TABLE [dbo].[tareas_programadas] (
    [id_tarea_programada]   CHAR (20)      NOT NULL,
    ...
    CONSTRAINT [PK_tareas_programadas_2] PRIMARY KEY CLUSTERED ([id_tarea_programada] ASC)
);
