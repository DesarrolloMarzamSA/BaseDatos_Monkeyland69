CREATE TABLE [dbo].[pedidos_leyva_20_historia] (
    ...
    CONSTRAINT [PK_pedidos_leyva_20_historia] PRIMARY KEY CLUSTERED ([cliente] ASC, [cod_barras] ASC, [cant_ped] ASC, [arch_cliente] ASC, [orden] ASC, [hash_md5] ASC, [fecha_pedido] ASC, [fechahistoria] ASC) WITH (FILLFACTOR = 90)
);
