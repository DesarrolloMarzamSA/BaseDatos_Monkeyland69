CREATE TABLE [dbo].[diferenciaFahorroDescComercial] (
    ...
    [diferenciaComercial]           NUMERIC (36, 7) NULL,
    [descComercialPesosAhorro]      MONEY           NULL,
    [descComercialPesosMarzam]      VARCHAR (50)    NULL,
    [porcentComercial]              MONEY           NULL,
    [pesosComercial]                NUMERIC (20, 2) NULL,
    [PesosComercialFarmaciasAhorro] NUMERIC (20, 2) NULL
);
