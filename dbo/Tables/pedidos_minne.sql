CREATE TABLE [dbo].[pedidos_minne] (
    ...
    [orden]            INT          NOT NULL,
    [mostrador]        VARCHAR (20) NULL,
    [descripcion]      VARCHAR (30) NULL,
    [fecha_pedido]     DATE         NULL,
    CONSTRAINT [PK__pedidos_minne__3ED2324F] PRIMARY KEY CLUSTERED ([sucursal] ASC, [cuenta] ASC, [pedido] ASC, [cod_barras] ASC, [cantidad_pedida] ASC, [arch_cliente] ASC, [orden] ASC) WITH (FILLFACTOR = 90)
);
