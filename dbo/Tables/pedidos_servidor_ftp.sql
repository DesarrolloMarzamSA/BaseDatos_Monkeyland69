CREATE TABLE [dbo].[pedidos_servidor_ftp] (
...
CREATE NONCLUSTERED INDEX [idx_pedidos_servidor_ftp]
    ON [dbo].[pedidos_servidor_ftp]([sucursal] ASC, [cuenta] ASC, [num_pedido] ASC, [hash_md5] ASC, [codigo] ASC) WITH (FILLFACTOR = 90);
