CREATE TABLE [dbo].[pedidos_farmapronto_historia] (
    ...
    CONSTRAINT [PK_pedidos_farmapronto_historia] PRIMARY KEY CLUSTERED ([cliente] ASC, [cod_barras] ASC, [cant_ped] ASC, [arch_cliente] ASC, [orden] ASC, [hash_md5] ASC, [fecha_pedido] ASC, [fechahistoria] ASC) WITH (FILLFACTOR = 90)
);
