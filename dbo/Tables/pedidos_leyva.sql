CREATE TABLE [dbo].[pedidos_leyva] (
    ...
    CONSTRAINT [PK_pedidos_leyva] PRIMARY KEY CLUSTERED ([cliente] ASC, [cod_barras] ASC, [cant_ped] ASC, [arch_cliente] ASC, [orden] ASC, [hash_md5] ASC, [fecha_pedido] ASC) WITH (FILLFACTOR = 90)
);
