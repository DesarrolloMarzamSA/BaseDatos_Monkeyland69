CREATE TABLE [dbo].[cfd_soriana_acuses_de_recibo_ohb] (
    ...
    CONSTRAINT [PK__cfd_sori__57B672321BD3DA2C] PRIMARY KEY CLUSTERED ([numTienda] ASC, [documento_soriana] ASC) WITH (FILLFACTOR = 90)
);
