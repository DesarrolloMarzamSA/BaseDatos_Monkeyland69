CREATE TABLE [dbo].[lab_sanofi2_factura] (
...
CREATE NONCLUSTERED INDEX [idx_lsanofi2_fe]
    ON [dbo].[lab_sanofi2_factura]([ClaveSucDist] ASC, [ClaveCliente] ASC, [FechaDoc] ASC, [Numero] ASC, [Pedido] ASC, [CodigoMat] ASC, [EAN] ASC, [CantFacturada] ASC) WITH (FILLFACTOR = 90);
