CREATE TABLE [dbo].[devolucionFahorroConciliacion] (
    ...
    [DESCCOMERCIAL]      VARCHAR (15)    NOT NULL,
    ...
    CONSTRAINT [PK_devolucionFahorroConciliacion] PRIMARY KEY CLUSTERED ([SUCURSAL] ASC, [IDCUNO] ASC, [IDINVN] ASC, [IDLINE] ASC, [IDPRDC] ASC, [IDQTY] ASC, [DTDCPR] ASC, [DESCCOMERCIAL] ASC, [IDGDSQ] ASC) WITH (FILLFACTOR = 90)
);


GO

CREATE NONCLUSTERED INDEX [NonClusteredIndex-20180308-163558]
    ON [dbo].[devolucionFahorroConciliacion]([IDCUNO] ASC, [IDINVN] ASC, [IDLINE] ASC, [IDPRDC] ASC, [PERIODO] ASC) WITH (FILLFACTOR = 90);
