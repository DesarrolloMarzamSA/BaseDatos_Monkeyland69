CREATE TABLE [dbo].[pedidos_pharmacy_apoyo] (
    ...
    [arch_cliente]                          VARCHAR (150) NOT NULL,
    [arch_tandem]                           VARCHAR (150) NULL,
    ...
    CONSTRAINT [PK_pedidos_pharmacy_apoyo] PRIMARY KEY CLUSTERED ([cliente] ASC, [cod_barras] ASC, [cant_ped] ASC, [arch_cliente] ASC, [orden] ASC, [hash_md5] ASC, [fecha_pedido] ASC) WITH (FILLFACTOR = 90)
);
