CREATE TABLE [dbo].[pedidos_servidor_ftp_historia] (
    ...
    PRIMARY KEY CLUSTERED ([sucursal] ASC, [cuenta] ASC, [orden] ASC, [hash_md5] ASC) WITH (FILLFACTOR = 90)
);


GO

CREATE NONCLUSTERED INDEX [idx_pedidos_servidor_ftp_historia]
    ON [dbo].[pedidos_servidor_ftp_historia]([sucursal] ASC, [cuenta] ASC, [num_pedido] ASC, [hash_md5] ASC, [codigo] ASC) WITH (FILLFACTOR = 90);
