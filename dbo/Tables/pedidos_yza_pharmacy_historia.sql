CREATE TABLE [dbo].[pedidos_yza_pharmacy_historia] (
    ...
    CONSTRAINT [PK_pedidos_yza_pharmacy_historia] PRIMARY KEY CLUSTERED ([cliente] ASC, [cod_barras] ASC, [cant_ped] ASC, [arch_cliente] ASC, [orden] ASC, [hash_md5] ASC, [fecha_pedido] ASC, [fechahistoria] ASC)
);
