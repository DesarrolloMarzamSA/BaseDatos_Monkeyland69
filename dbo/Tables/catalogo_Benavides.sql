CREATE TABLE [dbo].[catalogo_Benavides] (
    ...
    [FECHAACTUALIZACION]    DATETIME      CONSTRAINT [DF_catalogo_Benavides_FECHAACTUALIZACION] DEFAULT (getdate()) NULL,
    CONSTRAINT [PK_catalogo_Benavides] PRIMARY KEY CLUSTERED ([PRODUCTO] ASC, [P_FINAL_SIN_IMPUESTOS] ASC, [HASHCODE] ASC) WITH (FILLFACTOR = 90)
);


GO

CREATE NONCLUSTERED INDEX [NonClusteredIndex-20171024-124148]
    ON [dbo].[catalogo_Benavides]([PRODUCTO] ASC, [P_FARMACIA] ASC, [HASHCODE] ASC) WITH (FILLFACTOR = 90);


GO

CREATE NONCLUSTERED INDEX [NonClusteredIndex-20171023-175401]
    ON [dbo].[catalogo_Benavides]([PRODUCTO] ASC, [P_FARMACIA] ASC, [SUCURSAL] ASC, [HASHCODE] ASC) WITH (FILLFACTOR = 90);
