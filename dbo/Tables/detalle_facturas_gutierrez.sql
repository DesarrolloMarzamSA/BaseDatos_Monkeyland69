CREATE TABLE [dbo].[detalle_facturas_gutierrez] (
    ...
    CONSTRAINT [PK__detalle___519904D07F60ED59] PRIMARY KEY CLUSTERED ([SUCURSAL] ASC, [IDINVN] ASC, [IDLINE] ASC, [SERIE] ASC, [IDPRDC] ASC, [IDQTY] ASC) WITH (FILLFACTOR = 90)
);
