CREATE TABLE [dbo].[pedidos_spt_fahorro254] (
...
CREATE CLUSTERED INDEX [ClusteredIndex-20180129-101613]
    ON [dbo].[pedidos_spt_fahorro254]([orden] ASC, [sucursal] ASC, [cuenta] ASC, [codigo] ASC) WITH (FILLFACTOR = 90);
