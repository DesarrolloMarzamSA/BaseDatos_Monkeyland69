CREATE TABLE [dbo].[pedidos_ftp_yza_historia] (
    ...
    PRIMARY KEY CLUSTERED ([cuenta_estilo_yza] ASC, [orden] ASC, [hash_md5] ASC) WITH (FILLFACTOR = 90)
);


GO

CREATE NONCLUSTERED INDEX [idx_pedidos_ftp_yza_historia]
    ON [dbo].[pedidos_ftp_yza_historia]([sucursal] ASC, [cuenta] ASC, [num_pedido] ASC, [hash_md5] ASC, [codigo] ASC) WITH (FILLFACTOR = 90);
