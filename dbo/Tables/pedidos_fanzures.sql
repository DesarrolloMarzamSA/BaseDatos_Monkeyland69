CREATE TABLE [dbo].[pedidos_fanzures] (
    ...
    [orden]            INT          NOT NULL,
    [mostrador]        VARCHAR (3)  NULL,
    [descripcion]      VARCHAR (30) NULL,
    PRIMARY KEY CLUSTERED ([sucursal] ASC, [cuenta] ASC, [pedido] ASC, [codigo] ASC, [cantidad_pedida] ASC, [orden] ASC) WITH (FILLFACTOR = 90)
);
