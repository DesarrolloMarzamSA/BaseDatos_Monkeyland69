CREATE TABLE [dbo].[pedidos_carer] (
    ...
    CONSTRAINT [PK_pedidos_carer] PRIMARY KEY CLUSTERED ([cliente] ASC, [cant_ped] ASC, [codigo] ASC, [arch_cliente] ASC, [orden] ASC, [hash_md5] ASC, [fecha_pedido] ASC)
);
