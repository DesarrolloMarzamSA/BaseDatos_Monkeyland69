CREATE TABLE [dbo].[pedidos_fbenavides_historia] (
    [linea]            INT           NULL,
    ...
    PRIMARY KEY CLUSTERED ([fecha_pedido] ASC, [sucursal] ASC, [cliente] ASC, [pedido] ASC, [codigo] ASC, [cantidad_pedida] ASC) WITH (FILLFACTOR = 90)
);
