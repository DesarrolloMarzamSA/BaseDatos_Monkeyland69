CREATE TABLE [dbo].[lab_merckmx_factura] (
...
CREATE NONCLUSTERED INDEX [idx_lmerckmx_fe]
    ON [dbo].[lab_merckmx_factura]([ClaveSucDist] ASC, [ClaveCliente] ASC, [FechaDoc] ASC, [Numero] ASC, [Pedido] ASC, [CodigoMat] ASC, [EAN] ASC, [CantFacturada] ASC) WITH (FILLFACTOR = 90);
