...
-- =============================================
create PROCEDURE [dbo].[usp_facturacion_pharmacy_hydropharma]
AS
BEGIN
...
where		convert(varchar(10),t1.fecha_factura,112) >=  convert(varchar(10),GETDATE()-1,112) and  rtrim(t1.ctepadre)='258'
END
