CREATE procedure [dbo].[usp_genera_respuesta_pharmacy_floresRegalos]
...
from pedidos_pharmacy_floresRegalos_historia
where arch_cliente=@arch_cliente and hash_md5=@hash_md5 and cant_ped-isnull(cant_surt,0)>0
--select * from  pedidos_pharmacy_floresRegalos_historia
