...
-- =============================================
create PROCEDURE [dbo].[usp_benavides_actualiza_cliente_producto_pc] @hash_md5 varchar(150)
AS
BEGIN
...
--update p set p.letra=s.ibs_letra
----select p.sucursal,s.sucursal,p.letra,s.ibs_letra
-- from pedidos_fbenavides_ci_pc_historia p
--inner join sucursales s on p.sucursal=s.sucursal where p.hash_md5=@hash_md5
...
--select * from monkeyland..pedidos_fbenavides_ci_pc
update monkeyland..pedidos_fbenavides_ci_pc set cliente='00000',codigo='0000000' 
