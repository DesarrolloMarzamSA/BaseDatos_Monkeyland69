...
CREATE procedure [dbo].[usp_inserta_pedidos_pharmacy_calderon]
	@sucursal tinyint,
	@cliente varchar(15),
...
as	
	...
	from capa_ibs..clientes_baan where ctepadre='334' and cliente= @cliente
	
	select	@x_Cliente = cliente
	from capa_ibs..clientes_baan where ctepadre='334' and cliente=@cliente
	
	insert into	pedidos_pharmacy_calderon
					(
						sucursal, 
						cliente,
						cod_barras, 
