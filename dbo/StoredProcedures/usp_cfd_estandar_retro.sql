...
CREATE
--CREATE
PROCEDURE [dbo].[usp_cfd_estandar_retro] 

/*
execute usp_cfd_estandar_retro  '2011-07-04', 'WALMART'
*/
--declare
...
--set @fecha = '2011-01-03'
--SET @suc = 7
--SET @IDCliente = 'FBENAVIDES'
...
SET @query = @query + @header + CHAR(13) +
	...
	' AND e.fecha_tandem BETWEEN CONVERT(DATE,''2011-01-01'',121) ' + 
	' AND CONVERT(DATE,'''+@fecha+''',121) ' + 
--	' AND habilitado = 1 ' +
	' ORDER BY e.fechaprog, e.serie_cfd, e.folio_fiscal '
