...
CREATE procedure [dbo].[usp_bazar_notas_bonificacion_mostrador] @sucursal_param tinyint, @cliente_param char(5)
...
t1.segto = 'C2' and 
t1.ctepadre = '468' 
and not (t1.sucursal = 13 and t1.cliente = '14530') and
t1.sucursal = @sucursal_param and
t1.cliente = @cliente_param
