...
-- =============================================
CREATE PROCEDURE [dbo].[usp_facturacion_atz] @bnd int
AS
BEGIN
...
where  f.ctepadre='100'  and convert(varchar,f.fecha_factura,112) between convert(varchar,getdate()-1,112) and convert(varchar,getdate(),112)
