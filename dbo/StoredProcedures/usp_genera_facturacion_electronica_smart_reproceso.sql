CREATE 
PROCEDURE [dbo].[usp_genera_facturacion_electronica_smart_reproceso] @fecha varchar(10)--,@cliente varchar(6)
AS  
---[usp_genera_facturacion_electronica_smart_reproceso] '2021-12-20'
...
WHERE f.factura  in('00247553','00247822')
--f.fecha_factura between  CONVERT(datetime,@fecha,121)-1 and   CONVERT(datetime,@fecha,121)+1
...
where 
p.ALTKN='X52702'
-- p.[VBELN] in('0900514654','0900520334','0900520335')
AND p.[FKDAT] between CONVERT(datetime,@fecha,121)-2 and   CONVERT(datetime,@fecha,121)+1 
*/
