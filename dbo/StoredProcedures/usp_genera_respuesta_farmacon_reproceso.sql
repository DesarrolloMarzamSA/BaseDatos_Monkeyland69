...
GO
CREATE PROCEDURE [dbo].[usp_genera_respuesta_farmacon_reproceso]
	@hash_md5 varchar(50)
WITH ENCRYPTION
as
--declare @hash_md5 varchar(50)
--set @hash_md5 = 'e76ba2ee6838b2dc27370d20bca239dc'
select	right(replicate('0', 10) + convert(varchar(10), t1.num_pedido), 10) +
		...
		replicate('0', 13)
from 	pedidos_farmacon_historia t1 left join maestro_productos_baan t2 ON
		t1.codigo = t2.codigo 
