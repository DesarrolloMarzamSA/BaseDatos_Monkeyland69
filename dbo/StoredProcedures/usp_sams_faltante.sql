create procedure usp_sams_faltante
as
select 
'00' +
t1.cliente + 
...
inner join catalogo_autoservicios t3 on t1.segto = t3.segto and t1.ctepadre = t3.ctepadre and t1.sucursal = t3.sucursal and t3.codigo = t2.codigos
