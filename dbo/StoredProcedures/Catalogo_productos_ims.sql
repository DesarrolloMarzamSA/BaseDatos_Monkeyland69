...
CREATE PROCEDURE [dbo].[Catalogo_productos_ims]
AS
...
select RTRIM(pgprdc) as codigoMarzam,
	  ...
	  -- isnull(precioProveedor,0) as precioProveedor // se cambio el is null para quitar el cero en los precios de los catalogos
	    precioProveedor as precioProveedor
