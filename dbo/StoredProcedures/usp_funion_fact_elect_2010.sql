...
CREATE 
--	CREATE 
PROCEDURE [dbo].[usp_funion_fact_elect_2010] 
...
--	usp_funion_fact_elect_2010 '2010-01-15'
...
--	2011-01-24	SE RELLENAN CON CEROS LOS CODIGOS DE BARRAS A PETICION DE FUNION / ERICK SANCHEZ
--------------------------------------------------------------------------------------------------
SELECT 
*
INTO #Fact_Elec_FUnion_hoy
...
INSERT INTO #tmp_fact_elect
  ...
  where e.cliente not in (select cliente from cat_cuentas_fidealessureste)
