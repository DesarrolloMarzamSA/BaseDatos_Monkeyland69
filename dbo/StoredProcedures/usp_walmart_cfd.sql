...
/*
EXECUTE usp_walmart_cfd 7,'2010-08-11'
...
DEBIDO A LA CANTIDAD DE FACTURAS DE WALMART, se corre por sucursal
...
CREATE
--CREATE
PROCEDURE [dbo].[usp_walmart_cfd] 
--	DECLARE 
@suc INT, @fecha VARCHAR(10)
/*
SET @suc = 7
SET @fecha = '2010-08-11'
*/
...
WHERE e.sucursal = @suc
	...
	AND e.segto = 'E1' AND e.ctepadre = '004'
