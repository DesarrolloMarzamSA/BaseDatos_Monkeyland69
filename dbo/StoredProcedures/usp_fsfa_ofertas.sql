...
CREATE --	CREATE
PROCEDURE [dbo].[usp_fsfa_ofertas] @sucursal int
AS

/*
EXECUTE usp_fsfa_ofertas 3
*/
...
--insert into #tabla_salida 
  SELECT
    ...
    RIGHT('0000000'+convert(varchar(15),prec_farm)  ,7)				prec_farm		,
    right('0000' + cant_base   ,4)														cant_base		,
    right('0000' + cant_oferta ,4)														cant_oferta	,
    right('00'   + porc_dcto   ,2)														porc_descto	,
