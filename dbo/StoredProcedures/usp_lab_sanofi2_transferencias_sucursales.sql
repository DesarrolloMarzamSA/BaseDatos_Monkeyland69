CREATE --	CREATE	--	DROP
PROCEDURE [dbo].[usp_lab_sanofi2_transferencias_sucursales] (@fecha VARCHAR(10))

AS 

/*
EXECUTE usp_lab_sanofi2_transferencias_sucursales '2012-03-19'
SELECT * FROM lab_sanofi2_transfer_sucursal
SELECT * FROM lab_sanofi2_control_transfer_sucursal
*/

SELECT *
INTO #productos_sanofi2
...
ALTER TABLE #productos_sanofi2 ADD PRIMARY KEY (codigo)
...
IF EXISTS (SELECT 1 FROM INFORMATION_SCHEMA.TABLES 
    WHERE TABLE_TYPE='BASE TABLE' AND TABLE_NAME='lab_sanofi2_transfer_sucursal') 
	TRUNCATE TABLE lab_sanofi2_transfer_sucursal
ELSE
		CREATE TABLE lab_sanofi2_transfer_sucursal (
...
IF EXISTS (SELECT 1 FROM INFORMATION_SCHEMA.TABLES 
    WHERE TABLE_TYPE='BASE TABLE' AND TABLE_NAME='lab_sanofi2_control_transfer_sucursal') 
	TRUNCATE TABLE lab_sanofi2_control_transfer_sucursal

ELSE
	CREATE TABLE lab_sanofi2_control_transfer_sucursal (
...
INSERT INTO lab_sanofi2_transfer_sucursal
	SELECT 	--  TOP 25
	...
	INNER JOIN #productos_sanofi2 mpb ON '00' + mpb.codigo = det.codigos
	...
	--	CONVERT(SMALLDATETIME,'2012-02-01',121)  AND CONVERT(SMALLDATETIME,'2012-02-29',121)	
...
--------------------------------------------------------------------------------
declare @cuenta int
set @cuenta = (select count(*) FROM lab_sanofi2_transfer_sucursal)
if @cuenta = 0
	INSERT INTO lab_sanofi2_transfer_sucursal
		SELECT 
			''		ClaveDist,	--		
...
SET @total_registros = (SELECT COUNT(*) FROM lab_sanofi2_transfer_sucursal)
SET @sum_ean = (SELECT Sum(CONVERT(bigint,CodigoEAN)) FROM lab_sanofi2_transfer_sucursal)
SET @sum_cantidad = (SELECT Sum(Cantidad) FROM lab_sanofi2_transfer_sucursal)
...
---------------	20	OCT	2009	-------------------------
UPDATE lab_sanofi2_transfer_sucursal SET 
	ClaveSucursalOrig = RIGHT(REPLICATE('0',2) + CONVERT(VARCHAR,suc.almacen) ,2)
FROM lab_sanofi2_transfer_sucursal transfer
...
INSERT INTO lab_sanofi2_control_transfer_sucursal
SELECT
	 @total_registros	TotalRegistros,
	 @sum_ean					SumaEAN,
	 @sum_cantidad		SumaCantidad

UPDATE lab_sanofi2_transfer_sucursal SET NumeroLote = '', Texto1 = '', Texto2 = '', Texto3 = '' 

/*
UPDATE lab_sanofi2_transfer_sucursal SET ClaveSucursalOrig = '17' WHERE ClaveSucursalOrig = '50'
UPDATE lab_sanofi2_transfer_sucursal SET ClaveSucursalOrig = '18' WHERE ClaveSucursalOrig = '51'
UPDATE lab_sanofi2_transfer_sucursal SET ClaveSucursalOrig = '19' WHERE ClaveSucursalOrig = '52'

UPDATE lab_sanofi2_transfer_sucursal SET ClaveSucursalDest = '17' WHERE ClaveSucursalDest = '50'
UPDATE lab_sanofi2_transfer_sucursal SET ClaveSucursalDest = '18' WHERE ClaveSucursalDest = '51'
UPDATE lab_sanofi2_transfer_sucursal SET ClaveSucursalDest = '19' WHERE ClaveSucursalDest = '52'
*/
