...
--exec usp_genera_cambios_issste 1, '16730'
--select * from maestro_productos_baan where cod_barras = '7501119500489'
CREATE procedure [dbo].[usp_genera_cambios_issste] @sucursal int, @cliente varchar(5)
as
set nocount on
begin
...
select t_item, max(fecha_hora) fecha_hora from cambios_precio_baan 
where (fecha_hora > dateadd(dd, -1, current_timestamp) 
and convert(int, t_item) < dbo.gobierno()) 
or (convert(int, t_item) < dbo.gobierno() and t_item in  (
'0032004',
'0197509',
'0483006',
'0483007',
...
'2842002',
'2946801')) 
group by t_item order by t_item
...
update #cambios_issste set 
	cod_barras = t2.cod_barras, 
	nombre = t2.descripcion, 
	iva = t2.iva, descuento =  
	case 
