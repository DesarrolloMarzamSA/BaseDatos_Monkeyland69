...
WHERE CONVERT(VARCHAR(10),fechaprog,121) = @fecha  
	AND e.segto = 'C2' AND e.ctepadre IN ('571' , '012') and e.cliente not in (select cliente from cat_cuentas_fidealessureste)
