...
-- =============================================
--[usp_fanasa_archivo_embarque_reproceso] '20140227'
CREATE PROCEDURE [dbo].[usp_fanasa_archivo_embarque_reproceso] @fecha varchar(8)
AS
BEGIN
...
inner join MA4620EF04.SROEAN e on t1.IDPRDC=e.pjprdc
 where t1.IDIDAT='''''+@fecha+''''' and  oh.OHOTME between 0 and 235959--t1.IDINVN in(803000591132)
...
--select * from facturacion_fanasa order by idarea
...
--
--select * from pedidos_fanasa_historia where codigo_barras like '%7501033956690%' order by fecha_pedido desc


--select * from ArchivoFanasa where nombreArchivo like '%20130510.txt%'

--exec [usp_fanasa_archivo_embarque]
