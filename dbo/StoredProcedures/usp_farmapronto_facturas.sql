...
-- EXEC [usp_farmapronto_facturas] 0,'20220302','20220302'
-- =============================================

CREATE PROCEDURE [dbo].[usp_farmapronto_facturas] --1,
...
begin
     ...
     SELECT [Remision]
      ...
      from openquery(AS400,''
      	   ...
      	   INNER JOIN MA4620EF04.SRONAM ON OHCUNO=NANUM AND NANCA1 IN (''''99676'''',''''99292'''')
      	   ...
      	   INNER JOIN MA4620EF11.SRONAM ON OHCUNO=NANUM AND NANCA1 IN (''''99676'''',''''99292'''')
