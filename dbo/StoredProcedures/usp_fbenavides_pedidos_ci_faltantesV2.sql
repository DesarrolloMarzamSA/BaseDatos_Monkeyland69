...
CREATE
--	CREATE
PROCEDURE [dbo].[usp_fbenavides_pedidos_ci_faltantesV2] @archivo_cliente VARCHAR(300)
AS

/*
execute [usp_fbenavides_pedidos_ci_faltantesV2] 'edd20566c622ab76ddde02fe596a6d15'
*/
--select * from  pedidos_fbenavides_ci where hash_md5='edd20566c622ab76ddde02fe596a6d15'

BEGIN

if exists(SELECT * FROM sys.tables WHERE object_id = OBJECT_ID(N'faltanteBenavidesHistorico#') AND type in (N'U'))
begin
 drop table faltanteBenavidesHistorico#
 end
CREATE TABLE faltanteBenavidesHistorico#(
	...
	[fecha] [varchar](8) NULL
		...
		UPDATE pedidos_fbenavides_ci SET cantidad_surtida = 0 
		...
		update pedidos_fbenavides_ci set cantidad_surtida=0,estatus=1
