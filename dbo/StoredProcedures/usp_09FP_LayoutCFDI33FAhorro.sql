...
-- Description:	
-- =============================================
CREATE PROCEDURE [dbo].[usp_09FP_LayoutCFDI33FAhorro]
...
BEGIN
	...
	BEGIN 
		RAISERROR('¡No se puede realizar este proceso 09[GenerarLayoutCFDI3.3] ya que existe diferencía!',16,1);
		RETURN;
	END
	...
	BEGIN 
		RAISERROR('¡Ya se esta realizando un proceso 09[GenerarLayoutCFDI3.3] para este periodo favor de esperar el resultado!',16,1);
		RETURN;
	END
