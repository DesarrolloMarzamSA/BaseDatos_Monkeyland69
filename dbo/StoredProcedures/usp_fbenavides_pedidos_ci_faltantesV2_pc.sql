...
--	CREATE
CREATE procedure [dbo].[usp_fbenavides_pedidos_ci_faltantesV2_pc] @archivo_cliente VARCHAR(300)
AS

/*
execute [usp_fbenavides_pedidos_ci_faltantesV2] 'edd20566c622ab76ddde02fe596a6d15'
*/
--select * from  pedidos_fbenavides_ci_pc where hash_md5='edd20566c622ab76ddde02fe596a6d15'

BEGIN

if exists(SELECT * FROM sys.tables WHERE object_id = OBJECT_ID(N'faltanteBenavidesHistorico_pc#') AND type in (N'U'))
begin
 drop table faltanteBenavidesHistorico_pc#
 end
CREATE TABLE faltanteBenavidesHistorico_pc#(
	...
	[fecha] [varchar](8) NULL
		...
		UPDATE pedidos_fbenavides_ci_pc SET cantidad_surtida = 0 
		...
		--select * from pedidos_fbenavides_ci_pc where hash_md5='cbbf2ab2e8af00f3bd96f1beab6cfa71' 
		update pedidos_fbenavides_ci_pc set cantidad_surtida=0,estatus=1
		...
		insert into faltanteBenavidesHistorico_pc#
		SELECT   
		'05'																																														no_prov	,
		...
		from faltanteBenavidesHistorico_pc#
		drop table faltanteBenavidesHistorico_pc#
END
