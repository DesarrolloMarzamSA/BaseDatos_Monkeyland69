...
GO
CREATE	--	CREATE	--	DROP
PROCEDURE [dbo].[usp_lab_janssen_facturas] 
@fecha VARCHAR(10)
WITH ENCRYPTION
AS

/*
EXECUTE usp_lab_janssen_facturas	'2011-11-04'
...
EXECUTE usp_estadisticas_samayoa 'usp_lab_janssen_facturas', @total_registros, @ejecucion
