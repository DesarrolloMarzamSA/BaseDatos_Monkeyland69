...
GO
CREATE procedure [dbo].[usp_genera_respuesta_intermedia_pedidos_farmacon] 
	@hash_md5 varchar(50)
WITH ENCRYPTION
as
...
--set @hash_md5 = '95200f89b204f5be5bd68b4954089e26'
--set @x_Dummy = ''
...
from	pedidos_farmacon t1 inner join Capa_ibs.dbo.pedidos_traductor t2 on
