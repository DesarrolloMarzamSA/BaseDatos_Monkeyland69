...
CREATE PROCEDURE [dbo].[usp_fbenavides_fe_df_sap]
	@fecha VARCHAR(10)			
AS
-- exec [dbo].[usp_fbenavides_fe_df_sap] '2021-07-07'
...
[NOPEDIDO] as ORDEN,NETO_CANTIDAD,IVA_MONEDA,PRECIO_CANTIDAD,DESCUENTOPROD,0 as IVADESCUENTO,IDQTY,IEPS_MONEDA
	...
	convert(varchar,FECHAPROG,112) between '20210722' and '20210723' and sucursal=24-->=convert(varchar,getdate()-@dias,112) --and ESTATUSD in(1,2)
