...
CREATE procedure [dbo].[usp_genera_cambios_farmadepot]
as
...
inner join cambios_precio_baan t4 on t1.codigo = t4.t_item
where t4.fecha_hora > dateadd(dd, -5, current_timestamp) and
convert(int, t1.codigo) < 6900000 
