...
-- =============================================
CREATE PROCEDURE [dbo].[usp_reporte_excel_calderon] @parHashesMD5 varchar(max)
AS
BEGIN
	-- SET NOCOUNT ON added to prevent extra result sets from
	-- interfering with SELECT statements.
	-- usp_reporte_excel_calderon '''5ef411c301e9667f700f0b7a4d1bd454'',''5ef411c301e9667f700f0b7a4d1bd454'''
