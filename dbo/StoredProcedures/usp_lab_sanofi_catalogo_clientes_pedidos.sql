...
GO
/*	
execute usp_lab_sanofi_catalogo_clientes_pedidos --7, 
'2011-02-11'
*/
...
CREATE --	CREATE
PROCEDURE [dbo].[usp_lab_sanofi_catalogo_clientes_pedidos]
--	DECLARE
--@almacen INT, 
@fecha VARCHAR(10)
...
/*
EXECUTE usp_lab_sanofi_catalogo_clientes_pedidos --1, 
'2011-10-10'
*/
...
CUFA															VARCHAR(100)							,
rfc																VARCHAR(100)							,
Tipo_Cliente2											VARCHAR(100)							,
segmento													VARCHAR(100)							,
estatus_cliente										VARCHAR(100)							
