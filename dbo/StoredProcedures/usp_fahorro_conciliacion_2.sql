...
CREATE procedure [dbo].[usp_fahorro_conciliacion_2] @fecha_inicial varchar(10), @fecha_final varchar(10)
as
set nocount on
...
declare @orden bigint /*cambio a bigint 18-08-2023*/
...
t1.licitacion,
t1.contrato,
convert(bigint, convert(varchar(15), replace(replace(t1.orden, ' ', ''), '"', ''))) orden,/*cambio a big int 18-08-2023*/
t1.fianza,
t1.fechaalta,
t1.noalta,
t1.segto,
...
hash_md5,
convert(bigint, orden) orden,/*cambio a big int 18-08-2023*/
cod_barras,
...
desctoesp money,
orden bigint, /*cambio a bigint 18-08-2023*/
...
CREATE TABLE #facturacion_spt_fahorro(
	...
	[total] [money] NULL,
	[orden] bigint NULL,  /*cambio a bigint 18-08-2023*/
