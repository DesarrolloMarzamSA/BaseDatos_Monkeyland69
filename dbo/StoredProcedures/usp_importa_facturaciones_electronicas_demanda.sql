...
declare cur_sucursales cursor fast_forward for select sucursal, letra, ip, usuario, password, fact_elec from rutas_tandem where sucursal = 4 order by sucursal desc
open cur_sucursales
