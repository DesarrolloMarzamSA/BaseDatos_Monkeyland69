...
CREATE  procedure [dbo].[usp_ccc_catalogo_productos_normales] @sucursal tinyint
as
...
t1.clas_ssa not in (1,2,3)
-- Agregado al original by aacosta 24/06/2013 filtro para omitir clientes VIP
