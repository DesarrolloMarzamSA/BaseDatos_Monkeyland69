...
CREATE VIEW [dbo].[facturacion_electronica_estandar]
AS
SELECT   t1.sucursal , t1.cliente, t1.digito_verificador, t1.serie, t1.factura, t1.fecha_factura, t1.codigo, t1.descripcion, 
...
FROM         Historica.dbo.fes AS t1 WITH (nolock) LEFT OUTER JOIN
...
EXECUTE sp_addextendedproperty @name = N'MS_DiagramPane2', @value = N'
   ...
   End
End
', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'VIEW', @level1name = N'facturacion_electronica_estandar';


GO

EXECUTE sp_addextendedproperty @name = N'MS_DiagramPaneCount', @value = 2, @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'VIEW', @level1name = N'facturacion_electronica_estandar';
...
Begin DesignProperties = 
   ...
   Begin CriteriaPane = 
      Begin ColumnWidths = 11
         Column = 1440', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'VIEW', @level1name = N'facturacion_electronica_estandar';
