CREATE VIEW dbo.vw_reproceso_benavides
AS
...
WHERE     (t1.ctepadre IN ('319', '199')) AND (NOT (t1.cliente = '05961')) AND (t1.factura IN ('00481389', '00487134', '00495064', '00485941', '00485957'))

GO

EXECUTE sp_addextendedproperty @name = N'MS_DiagramPaneCount', @value = 1, @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'VIEW', @level1name = N'vw_reproceso_benavides';
...
Begin DesignProperties = 
   ...
   End
End
', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'VIEW', @level1name = N'vw_reproceso_benavides';
