CREATE VIEW dbo.facturacion_benavides
AS
...
WHERE     (t1.fechaprog >= DATEADD(dd, - 2, CONVERT(datetime, GETDATE(), 112))) AND (t1.ctepadre IN ('319', '199')) AND (NOT (t1.cliente = '05961'))
...
Begin DesignProperties = 
   ...
   End
End
', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'VIEW', @level1name = N'facturacion_benavides';


GO

EXECUTE sp_addextendedproperty @name = N'MS_DiagramPaneCount', @value = 1, @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'VIEW', @level1name = N'facturacion_benavides';
